...
const entities = [
    {
        ...
        type: "Platform",
        description: "Institutional-grade AI-native fintech ecosystem combining copy trading, journaling, charting, market intelligence, and education.",
        url: BASE_URL,
        canonical: BASE_URL,
        jsonld: {
        ...
        faq: [
            {
                ...
                answer: "Integral Market is an AI-native fintech ecosystem that provides copy trading, trading journals, advanced charting, market intelligence, and structured education.",
            },
            {
                question: "Is Integral Market free to use?",
                answer: "Integral Market offers a free tier for core features. Premium plans unlock advanced analytics, AI features, and priority support.",
            },
        ],
        landingPage: "/",
    ...
    },
    {
        ...
        name: "IM Academy",
        type: "Course",
        description: "Structured trading education with expert-led courses on forex, stocks, cryptocurrency, and AI-assisted trading strategies.",
        ...
        faq: [
            {
                ...
                answer: "IM Academy offers courses on forex trading, stock market fundamentals, cryptocurrency markets, AI-assisted trading, and trading psychology.",
            },
            {
                question: "Are the courses self-paced?",
                answer: "Yes. All courses are self-paced with lifetime access. Each module includes video lessons, quizzes, and practical exercises.",
            },
        ],
        landingPage: "/academy",
    ...
    },
    {
        ...
        name: "IM Library",
        type: "Book",
        description: "Curated digital library of trading books, research papers, strategy documentation, and market analysis reports.",
        ...
        jsonld: {
            ...
            "@id": `${BASE_URL}/library`,
            name: "IM Library",
            description: "Curated digital library of trading books, research papers, and strategy documentation.",
            url: `${BASE_URL}/library`,
            isPartOf: { "@id": ORG_ID },
            provider: { "@id": ORG_ID },
        },
        ...
        faq: [
            {
                ...
                answer: "IM Library contains trading books, academic research papers, strategy guides, and market analysis reports organized by topic and difficulty level.",
            },
        ],
        landingPage: "/library",
    ...
    },
    {
        ...
        name: "AI Journal",
        type: "Product",
        description: "AI-powered trading journal with automated trade logging, performance analytics, and behavioral insights.",
        ...
        faq: [
            {
                ...
                answer: "The AI Journal automatically logs trades from your connected broker, analyzes patterns, and provides behavioral insights to improve your trading performance.",
            },
            {
                question: "Which brokers are supported?",
                answer: "AI Journal supports MT5, Binance, and cTrader integrations for automated trade sync.",
            },
        ],
        landingPage: "/journal",
    ...
    },
    {
        ...
        type: "Product",
        description: "Manual and MT5-synced trading journal with advanced analytics, risk management metrics, and performance tracking.",
        url: `${BASE_URL}/journal`,
        canonical: `${BASE_URL}/journal`,
        jsonld: {
            "@context": "https://schema.org",
        ...
        faq: [
            {
                ...
                answer: "Yes. You can manually log trades or enable automatic sync from MT5 and other supported brokers.",
            },
        ],
        landingPage: "/journal",
    ...
    },
    {
        ...
        type: "Capability",
        description: "Real-time AI-powered market analysis combining technical, fundamental, and sentiment data from multiple sources.",
        ...
        faq: [
            {
                ...
                answer: "Market Intelligence aggregates data from financial news APIs, social sentiment feeds, on-chain analytics, and technical indicator engines.",
            },
            {
                question: "Is the analysis real-time?",
                answer: "Yes. Market Intelligence processes data in real-time and updates analysis continuously during market hours.",
            },
        ],
    ...
    },
    {
        ...
        name: "Copy Trading",
        type: "Product",
        description: "Social copy trading platform connecting signal providers with subscribers for automated trade replication.",
        ...
        faq: [
            {
                ...
                answer: "Signal providers share their trades in real-time. Subscribers can automatically replicate those trades in their own accounts.",
            },
            {
                question: "How are signal providers verified?",
                answer: "Providers undergo performance verification including track record analysis, risk metrics, and consistency scoring.",
            },
        ],
    ...
    },
    {
        ...
        name: "imCharts",
        type: "Feature",
        description: "Advanced charting suite with TradingView integration, watchlists, and trade execution directly from charts.",
        url: `${BASE_URL}/charts`,
        ...
        faq: [
            {
                ...
                answer: "imCharts integrates TradingView's charting library with custom indicators, watchlists, and direct trade execution.",
            },
        ],
        landingPage: "/charts",
    ...
    },
    {
        ...
        name: "Forex Trading",
        type: "Topic",
        description: "Foreign exchange trading — currency pairs, market hours, broker integration, and MT5 connectivity.",
        ...
        faq: [
            {
                ...
                answer: "Forex trading is the buying and selling of currency pairs in the foreign exchange market, the largest and most liquid financial market in the world.",
            },
        ],
    ...
    },
    {
        ...
        name: "Stock Trading",
        type: "Topic",
        description: "Equity market trading — stock analysis, portfolio management, and long/short strategies.",
        ...
        faq: [
            {
                ...
                answer: "Start with IM Academy's stock trading fundamentals course covering market structure, technical analysis, and risk management.",
            },
        ],
    ...
    },
    {
        ...
        type: "Topic",
        description: "Digital asset trading — BTC, ETH, altcoins, DeFi strategies, and exchange integrations.",
        ...
        faq: [
            {
                ...
                answer: "Integral Market supports major cryptocurrencies including BTC, ETH, and top altcoins through integrated exchanges like Binance.",
            },
        ],
    ...
    },
    {
        ...
        type: "Capability",
        description: "LLM-powered trading assistant for trade journaling, strategy analysis, and real-time market Q&A.",
        ...
        faq: [
            {
                ...
                answer: "It analyzes your trades, identifies patterns, answers market questions, and helps you maintain a structured trading journal.",
            },
        ],
    ...
    },
    {
        ...
        type: "Topic",
        description: "Behavioral finance, emotional discipline, and psychological frameworks for consistent trading performance.",
        ...
        faq: [
            {
                ...
                answer: "Trading psychology governs decision-making under uncertainty. Mastering it reduces emotional errors and improves consistency.",
            },
        ],
    ...
    },
    {
        ...
        name: "Backtesting",
        type: "Capability",
        description: "Strategy backtesting engine for validating trading strategies against historical market data.",
        ...
        faq: [
            {
                ...
                answer: "Backtesting supports historical OHLCV data across forex, stocks, and cryptocurrency markets with configurable timeframes.",
            },
        ],
